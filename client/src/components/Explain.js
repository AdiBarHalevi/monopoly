    ...
    <WelcomePage>
      ...
      {displayButtons&& 
          <ConnectionLine width = {lineState}>
            <Button onClick={()=>handleclick(setDisplayReactMap,displayReactMap)}> React App</Button>
            <Button onClick={()=>handleclick(setDisplayServerMap,displayServerMap)}> Server Side</Button>
          </ConnectionLine>
      }
      <FlexBox>
      ...
      {displayReactMap &&
        <FrontEndChart>
          <table>
            <tbody>
              ...
              <tr>
                <Td>
                  all styling feature was made with <strong>Styled components</strong> 
                </Td>
              </tr>
              <tr>
                <Td>
                  extensive use of <strong>React States</strong> during the game Play 
                </Td>
              </tr>
              <tr>
                <Td>
        ...
        <table>
            <tbody>
              <tr>
                <Td>
                  Generated my own API and stored on Atlas by <strong>MongoDB</strong> 
                </Td>
              </tr>
              <tr>
                <Td>
                  Routes and Controllers specific for the API calls
                </Td>
              </tr>
              <tr>
                <Td>
                  All code on the Server side was written with <strong>Node JS</strong>
                </Td>
              </tr>
            </tbody>
          </table>
