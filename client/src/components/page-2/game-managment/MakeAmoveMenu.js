...
const MakeAmoveMenu = (props)=>{
    ...
    if(InvestOrMortgageState) return (
        <ActionBoxContainer boxState="flex">
            <AssetCardsContainer>
                    <InvestOrMortgage/>
            <button onClick={()=>setInvestOrMortgageState(false)}> go back</button>
            </AssetCardsContainer>
        </ActionBoxContainer>
    )
    else return (
        <ActionBoxContainer boxState="flex">
                    ...
                    <button onClick={()=>setInvestOrMortgageState(true)}> Invest Or mortgage your asset</button>
                    <button onClick={()=>props.setMakeAmoveState(false)}> go back</button>
                    </AssetCardsContainer>
         </ActionBoxContainer>)
}
